...
namespace SmartGeoLogical.Render.Bore
{

    /// <summary>
    /// 岩性描述
    /// </summary>
    public class BeginTime : Control
    {
        ...
        public BeginTime(RectangleF rect, Color outLineColor, Color fillColor, bool drawOutLine, bool fillInner, string name)
        ...
        {
            string str = layerInfo.BeginTime;
        ...
        private void drawDescription(LayerInfo layer, int index, Graphics g)
        {
            ...
            if (bottoms[index] > primitiveBottom[index])   //需要拉线
            {
                ...
                g.DrawString(layer.BeginTime, this.fontStyleD, new SolidBrush(Color.Black), new RectangleF(Left + Width / 20, topElevation + (bottomElevation - topElevation) / 20 + 5, Width * 9 / 10, bottomElevation - topElevation));
            ...
            else                                           //不需要拉线
            {
                ...
                g.DrawString(layer.BeginTime, this.fontStyleD, new SolidBrush(Color.Black), new RectangleF(Left + Width / 20, topElevation, Width * 9 / 10 + 5, bottomElevation - topElevation));
